...
class MainWindow(QMainWindow):
    DEFAULT_GRAPH = './delay_included_NREN.graphml'
    ...
    def __init__(self):
        ...
        self.button = self.findChild(QWidget, 'drawthickness_button')
        self.button.clicked.connect(self.view.scene.display_thickness)

        self.button1 = self.findChild(QWidget, 'drawgradient_button')
        self.button1.clicked.connect(self.view.scene.display_gradient)
