...
def bottleneck(graph, source, target, capacity=None, output="e"):
    ...
    :param capacity: the capacity of the edges. It must be a list or a valid attribute name or None. In the latter case,
    every edge will have the same capacity
    :param output: ignore this for now
    :return: a list of ids of edges that cause the bottleneck between two vertices
    """
